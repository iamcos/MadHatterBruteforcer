...
class BotDB:
    ...
    def save_botlist_to_file(botlist):
        ...
        frozenobjlist = []
        filename = str(t.strftime("%b %d %y %H:%M")+' '+str(botlist[0].priceMarket.primaryCurrency)+' '+str(botlist[0].priceMarket.secondaryCurrency)+' best ROI '+str(botlist[0].roi)+' .haasbots')
