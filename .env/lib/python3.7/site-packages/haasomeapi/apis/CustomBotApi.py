...
class CustomBotApi(ApiBase):
    ...
    def setup_mad_hatter_bot(self, accountguid: str, botguid: str, botname: str, primarycoin: str, secondarycoin: str, contractname: str,
                             ...
                             mappedbuysignal: EnumFundPosition, mappedsellsignal: EnumFundPosition, leverage: float ):
