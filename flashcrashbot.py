...
def getfcconfig(currentBotGuid):
				...
				fcdict.update({'botGuid':basebotconfig.guid, 'botname':basebotconfig.name,'accountguid': basebotconfig.accountId, 'primarycoin':missingmarketdata['primarycoin'] , 'secomdarycoin':missingmarketdata['secomdarycoin'], 'fee':missingmarketdata['fee'], 'baseprice': basebotconfig.basePrice, 'pricespreadtype': basebotconfig.priceSpreadType, 'percentageboost': basebotconfig.percentageBoost, 'minpercentage': basebotconfig.minPercentage, 'maxPercentage': basebotconfig.maxPercentage, 'ammounttype':basebotconfig.amountType, 'ammountspread':basebotconfig.amountSpread, 'sellammount':basebotconfig.sellAmount, 'refilldelay':basebotconfig.refillDelay, 'safetyenabled':basebotconfig.safetyEnabled, 'safetyTriggerLevel':basebotconfig.safetyTriggerLevel,'safetyMoveInOut':basebotconfig.safetyMoveInOut,'fttEnabled':basebotconfig.fttEnabled, 'fttRange':basebotconfig.fttRange, 'fttOffset':basebotconfig.fttOffset, 'fttTimeout': basebotconfig.fttTimeout})
